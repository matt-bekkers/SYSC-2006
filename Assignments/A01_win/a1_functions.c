...
void init_activity(activity_t * activity_to_int) {
	...
	printf("\nPlanned cost has been calculated to %d.\n", planned_cost);
...
void init_milestone(milestone_t * milestone_to_int, unsigned short int number_activities) {
	int id;
	char name[100];
	_Bool milestone_completed = false;
	unsigned short int milestone_performance_in_terms_of_cost = 0;
	unsigned short int milestone_performance_in_terms_of_time = 0;
